    ...
    return (
        <Section>
            ...
            >
                ...
                {cta[0].type === `internal` ?
                    <Button as={GatsbyLink} className={`button button--primary button--icon sm:text--xl`} to={cta[0].linkInternal.link}>
                        {cta[0].label}
                ...
                :
                    <Button className={`button button--primary button--icon sm:text--xl`} href={cta[0].linkExternal} target={cta[0].scopeExternal && `_blank`}>
                        {cta[0].label}
                        <svg fill="none" xmlns="http://www.w3.org/2000/svg" width="18" height="12" viewBox="0 0 18 12">
                            <path d="M12.038.343l-1.411 1.418 3.27 3.255-13.605.013.002 2 13.568-.013-3.215 3.23 1.417 1.41 5.644-5.67-5.67-5.643z" fill="#fff"></path>
                        </svg>
