...
const IntroComponent = ({
    ...
    const isVideo = (videoBannerType === 'internal' || videoBannerType === 'external' )
    ...
    }, [ wrapper, playing, videoBannerType, isVideo])
        ...
        <Section>
            <Container>
                <Wrapper>
                    ...
                    {videoBannerType === 'background' && <GatsbyImage fluid={videoPlaceholder.localFile.childImageSharp.fluid} />}
                    {isVideo && <VideoWrapper ref={wrapper}>
                        <Video
